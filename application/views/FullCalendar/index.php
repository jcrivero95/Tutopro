...
$sql = "select c.creada_en as fechaInicio, c.fecha as fechaFin, c.nombre, c.id from citas c 
                        inner join matricula m on m.id = c.idMatricula 
                        inner join usuarios u on u.id = m.idEstudiante 
                        where m.idEstudiante = $idUSer and c.estado = 'procesada'; ";
...
<body>
    ...
    <script src="j<?php echo base_url()?>fullcalendar/s/bootstrap.min.js"></script>
